...
# with command line options: V0fragmentfile/V0PbPb_2015/python/Pythia8_Lamdapt1p0_Pthat80_TuneCUETP8M1_5020GeV_cfi.py --conditions auto:run2_mc --eventcontent RAWSIM -s GEN,SIM --datatier GEN-SIM --beamspot NominalHICollision2015 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('V0fragmentfile/V0PbPb_2015/python/Pythia8_Lamdapt1p0_Pthat80_TuneCUETP8M1_5020GeV_cfi.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Pythia8_Lamdapt1p0_Pthat80_TuneCUETP8M1_5020GeV_cfi_py_GEN_SIM.root'),
...
process.V0filter = cms.EDFilter("MCSingleParticleFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.V0filter)
